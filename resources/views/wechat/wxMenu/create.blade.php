...
@section('content')
    <div class="card" id="app">
        <form class="mt-3" action="{{route ('wechat.wxMenu.store')}}" method="post">
            @csrf
            <div class="card-body">
                <ul class="nav nav-tabs nav-tabs-sm">
                    ...
                    <li class="nav-item">
                        <a href="{{route ('wechat.wxMenu.create')}}" class="nav-link active">
                            菜单添加
                        </a>
                    </li>
                </ul>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" v-if="activeMenu.type == 'click'">
                                    <label for="">关键词</label>
                                    <input type="text" class="form-control" placeholder="" aria-describedby="helpId">
                                </div>
