                        ...
                        <div class="news">
                            ...
                            <div class="item" v-for="(v,k) in news" v-if="k > 0">
                                ...
                                <div class="edit">
                                    ...
                                    <button class="btn btn-secondary btn-sm" type="button" v-if="k < news.length - 1" @click="next(k)">下移</button>
                                </div>
                            </div>
                            <div class="pt-2">
                                <button class="btn btn-secondary btn-block" type="button" @click="add()" v-if="news.length < 8">添加图文</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
    ...
    <script>
        require(['vue', 'hdjs'], function (vue, hdjs) {
            new vue({
                el: '#news',
                data: {
                    news: {!! $news['data'] !!}, //所有图文消息
                    active:{!! $news['data'] !!}[0], //当前操作的图文消息
                },
                methods: {
                    upImagePc() {
                        hdjs.image( (images) => {
