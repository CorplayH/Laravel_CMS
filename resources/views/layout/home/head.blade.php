                                    ...
                                    <div class="col ml--2">
                                        ...
                                        <div class="small text-muted">
                                            <strong class="text-body">Dianna Smiley</strong> shared your post with <strong
                                                class="text-body">Ab Hadley</strong>, <strong class="text-body">Adolfo Hess</strong>, and
                                            <strong class="text-body">3 others</strong>.
                                        </div>
                            ...
                            <a class="list-group-item px-0" href="#!">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <!-- Avatar -->
                                        <div class="avatar avatar-sm">
                                            <img src="{{asset('org/Dashkit/dist/assets')}}/img/avatars/profiles/avatar-2.jpg" alt="..."
                                                 class="avatar-img rounded-circle">
                                        </div>
                            ...
                            <a class="list-group-item px-0" href="#!">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <!-- Avatar -->
                                        <div class="avatar avatar-sm">
                                            <img src="{{asset('org/Dashkit/dist/assets')}}/img/avatars/profiles/avatar-3.jpg" alt="..."
                                                 class="avatar-img rounded-circle">
                                        </div>
                                    ...
                                    <div class="col ml--2">
                                        ...
                                        <div class="small text-muted">
                                            ...
                                            <blockquote class="text-body">“I don’t think this really makes sense to do without approval from
                            ...
                            <a class="list-group-item px-0" href="#!">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <!-- Avatar -->
                                        <div class="avatar avatar-sm">
                                            <img src="{{asset('org/Dashkit/dist/assets')}}/img/avatars/profiles/avatar-4.jpg" alt="..."
                                                 class="avatar-img rounded-circle">
                                        </div>
                            ...
                            <a class="list-group-item px-0" href="#!">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <!-- Avatar -->
                                        <div class="avatar avatar-sm">
                                            <img src="{{asset('org/Dashkit/dist/assets')}}/img/avatars/profiles/avatar-5.jpg" alt="..."
                                                 class="avatar-img rounded-circle">
                                        </div>
                                    ...
                                    <div class="col ml--2">
                                        ...
                                        <!-- Content -->
                                        <div class="small text-muted">
                                            <strong class="text-body">Miyah Myles</strong> shared your post with <strong class="text-body">Ryu
                                                Duke</strong>, <strong class="text-body">Glen Rouse</strong>, and <strong class="text-body">3
                                                others</strong>.
                                        </div>
                            ...
                            <a class="list-group-item px-0" href="#!">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <!-- Avatar -->
                                        <div class="avatar avatar-sm">
                                            <img src="{{asset('org/Dashkit/dist/assets')}}/img/avatars/profiles/avatar-6.jpg" alt="..."
                                                 class="avatar-img rounded-circle">
                                        </div>
                            ...
                            <a class="list-group-item px-0" href="#!">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <!-- Avatar -->
                                        <div class="avatar avatar-sm">
                                            <img src="{{asset('org/Dashkit/dist/assets')}}/img/avatars/profiles/avatar-7.jpg" alt="..."
                                                 class="avatar-img rounded-circle">
                                        </div>
                            ...
                            <a class="list-group-item px-0" href="#!">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <!-- Avatar -->
                                        <div class="avatar avatar-sm">
                                            <img src="{{asset('org/Dashkit/dist/assets')}}/img/avatars/profiles/avatar-8.jpg" alt="..."
                                                 class="avatar-img rounded-circle">
                                        </div>
