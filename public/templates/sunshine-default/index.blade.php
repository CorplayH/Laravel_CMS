...
<head>
    ...
    <link rel="stylesheet" href="{{asset('templates/sunshine-default/css')}}/bootstrap.css">
    <link rel="stylesheet" href="{{asset('templates/sunshine-default/css')}}/normalize.css">
    <link rel="stylesheet" href="{{asset('templates/sunshine-default/css')}}/transition-animations.css">
    <link rel="stylesheet" href="{{asset('templates/sunshine-default/css')}}/owl.carousel.css">
    <link rel="stylesheet" href="{{asset('templates/sunshine-default/css')}}/magnific-popup.css">
    <link rel="stylesheet" href="{{asset('templates/sunshine-default/css')}}/animate.css">
    <link rel="stylesheet" href="{{asset('templates/sunshine-default/css')}}/main.css" type="text/css">

    <script src="{{asset('templates/sunshine-default/js')}}/jquery-2.1.3.min.js"></script>
    <script src="{{asset('templates/sunshine-default/js')}}/modernizr.custom.js"></script>
...
<div id="page" class="page">
    ...
    <header id="site_header" class="header mobile-menu-hide">
        <div class="my-photo">
            <img src="{{asset('templates/sunshine-default/images')}}/my_photo.png" alt="image">
            <div class="mask"></div>
        </div>
    ...
    <div id="main" class="site-main">
        ...
        <div class="pt-wrapper">
            ...
            <div class="subpages">
                ...
                <!-- Home Subpage -->
                <section class="pt-page pt-page-1 section-with-bg section-paddings-0" style="background-image: url({{asset('templates/sunshine-default/images')}}/home_page_bg_1.jpg);" data-id="home">
                ...
                <section class="pt-page pt-page-2" data-id="about_me">
                            ...
                            <div class="testimonials owl-carousel">
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-credits">
                                        ...
                                        <div class="testimonial-picture">
                                            <img src="{{asset('templates/sunshine-default/images')}}/testimonials/testimonila_photo_2.png" alt="">
                                        </div>
                                        <!-- /Picture -->
                                ...
                                <div class="testimonial-item" style="width:100%">
                                    ...
                                    <div class="testimonial-credits">
                                        <!-- Picture -->
                                        <div class="testimonial-picture">
                                            <img src="{{asset('templates/sunshine-default/images')}}/testimonials/testimonial_photo_1.png" alt="">
                                        </div>
                                        <!-- /Picture -->
                                        <!-- Testimonial author information -->
                                        <div class="testimonial-author-info">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-3 subpage-block">
                            <div class="service-block">
                                <div class="service-info">
                                    <img src="{{asset('templates/sunshine-default/images')}}/service/web_design.png" alt="Responsive Design">
                                    <h4>Web Design</h4>
                        ...
                        <div class="col-sm-6 col-md-3 subpage-block">
                            <div class="service-block">
                                <div class="service-info">
                                    <img src="{{asset('templates/sunshine-default/images')}}/service/copywrite.png" alt="Copywriter">
                                    <h4>Copywriter</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-3 subpage-block">
                            <div class="service-block">
                                <div class="service-info">
                                    <img src="{{asset('templates/sunshine-default/images')}}/service/ecommerce.png" alt="E-Commerce">
                                    <h4>E-Commerce</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-3 subpage-block">
                            <div class="service-block">
                                <div class="service-info">
                                    <img src="{{asset('templates/sunshine-default/images')}}/service/management.png" alt="Management">
                                    <h4>Management</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-2 subpage-block">
                            <div class="client_block">
                                <a href="#" target="_blank"><img src="{{asset('templates/sunshine-default/images')}}/clients/client_1.png" alt="image"></a>
                            </div>
                        </div>

                        <div class="col-sm-4 col-md-2 subpage-block">
                            <div class="client_block">
                                <a href="#" target="_blank"><img src="{{asset('templates/sunshine-default/images')}}/clients/client_2.png" alt="image"></a>
                            </div>
                        </div>

                        <div class="col-sm-4 col-md-2 subpage-block">
                            <div class="client_block">
                                <a href="#" target="_blank"><img src="{{asset('templates/sunshine-default/images')}}/clients/client_3.png" alt="image"></a>
                            </div>
                        </div>

                        <div class="col-sm-4 col-md-2 subpage-block">
                            <div class="client_block">
                                <a href="#" target="_blank"><img src="{{asset('templates/sunshine-default/images')}}/clients/client_4.png" alt="image"></a>
                            </div>
                        </div>

                        <div class="col-sm-4 col-md-2 subpage-block">
                            <div class="client_block">
                                <a href="#" target="_blank"><img src="{{asset('templates/sunshine-default/images')}}/clients/client_5.png" alt="image"></a>
                            </div>
                        </div>

                        <div class="col-sm-4 col-md-2 subpage-block">
                            <div class="client_block">
                                <a href="#" target="_blank"><img src="{{asset('templates/sunshine-default/images')}}/clients/client_6.png" alt="image"></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="portfolio_grid" class="portfolio-grid portfolio-masonry masonry-grid-3">
                            ...
                            <figure class="item" data-groups='["all", "media"]'>
                                <a class="ajax-page-load" href="portfolio-1.html">
                                    <img src="{{asset('templates/sunshine-default/images')}}/portfolio/1.jpg" alt="">
                                    <div>
                            ...
                            <figure class="item" data-groups='["all", "video"]'>
                                <a href="https://player.vimeo.com/video/97102654?autoplay=1" title="Praesent Dolor Ex" class="lightbox mfp-iframe">
                                    <img src="{{asset('templates/sunshine-default/images')}}/portfolio/2.jpg" alt="">
                                    <div>
                                        <h5 class="name">Project Name</h5>
                                        <small>Video</small>
                            ...
                            <figure class="item" data-groups='["all","illustration"]'>
                                <a href="{{asset('templates/sunshine-default/images')}}/portfolio/3.jpg" class="lightbox" title="Duis Eu Eros Viverra">
                                    <img src="{{asset('templates/sunshine-default/images')}}/portfolio/3.jpg" alt="">
                                    <div>
                                        <h5 class="name">Project Name</h5>
                            ...
                            <figure class="item" data-groups='["all", "media"]'>
                                <a class="ajax-page-load" href="portfolio-1.html">
                                    <img src="{{asset('templates/sunshine-default/images')}}/portfolio/4.jpg" alt="">
                                    <div>
                                        <h5 class="name">Project Name</h5>
                                        <small>Media</small>
                                        <i class="fa fa-file-text-o"></i>
                            ...
                            <!-- Portfolio Item 5 -->
                            <figure class="item" data-groups='["all", "illustration"]'>
                                <a href="{{asset('templates/sunshine-default/images')}}/portfolio/5.jpg" class="lightbox" title="Aliquam Condimentum Magna Rhoncus">
                                    <img src="{{asset('templates/sunshine-default/images')}}/portfolio/5.jpg" alt="">
                                    <div>
                                        <h5 class="name">Project Name</h5>
                                        <small>Illustration</small>
                                        <i class="fa fa-image"></i>
                            ...
                            <figure class="item" data-groups='["all", "media"]'>
                                <a class="ajax-page-load" href="portfolio-1.html">
                                    <img src="{{asset('templates/sunshine-default/images')}}/portfolio/6.jpg" alt="">
                                    <div>
                                        <h5 class="name">Project Name</h5>
                                        <small>Media</small>
                                        <i class="fa fa-file-text-o"></i>
                            ...
                            <figure class="item" data-groups='["all", "video"]'>
                                <a href="https://player.vimeo.com/video/97102654?autoplay=1" title="Nulla Facilisi" class="lightbox mfp-iframe">
                                    <img src="{{asset('templates/sunshine-default/images')}}/portfolio/7.jpg" alt="">
                                    <div>
                                        <h5 class="name">Project Name</h5>
                                        <small>Video</small>
                                        <i class="fa fa-video-camera"></i>
                            ...
                            <figure class="item" data-groups='["all",  "media"]'>
                                <a class="ajax-page-load" href="portfolio-1.html">
                                    <img src="{{asset('templates/sunshine-default/images')}}/portfolio/8.jpg" alt="">
                                    <div>
                                        <h5 class="name">Project Name</h5>
                                        <small>Media</small>
                                        <i class="fa fa-file-text-o"></i>
                            ...
                            <!-- Portfolio Item 9 -->
                            <figure class="item" data-groups='["all","illustration"]'>
                                <a href="{{asset('templates/sunshine-default/images')}}/portfolio/9.jpg" class="lightbox" title="Mauris Neque Dolor">
                                    <img src="{{asset('templates/sunshine-default/images')}}/portfolio/9.jpg" alt="">
                                    <div>
                                        <h5 class="name">Project Name</h5>
                                        <small>Illustration</small>
                                        <i class="fa fa-image"></i>
                            ...
                            <figure class="item" data-groups='["all", "video"]'>
                                <a href="https://player.vimeo.com/video/97102654?autoplay=1" title="Donec Lectus Arcu" class="lightbox mfp-iframe">
                                    <img src="{{asset('templates/sunshine-default/images')}}/portfolio/10.jpg" alt="">
                                    <div>
                                        <h5 class="name">Project Name</h5>
                                        <small>Video</small>
                                        <i class="fa fa-video-camera"></i>
                            ...
                            <!-- Portfolio Item 11 -->
                            <figure class="item" data-groups='["all","illustration"]'>
                                <a href="{{asset('templates/sunshine-default/images')}}/portfolio/11.jpg" class="lightbox" title="Duis Eu Eros Viverra">
                                    <img src="{{asset('templates/sunshine-default/images')}}/portfolio/11.jpg" alt="">
                                    <div>
                                        <h5 class="name">Project Name</h5>
                                        <small>Illustration</small>
                                        <i class="fa fa-image"></i>
                            ...
                            <figure class="item" data-groups='["all","media"]'>
                                <a class="ajax-page-load" href="portfolio-1.html">
                                    <img src="{{asset('templates/sunshine-default/images')}}/portfolio/12.jpg" alt="">
                                    <div>
                                        <h5 class="name">Project Name</h5>
                                        <small>Media</small>
                                        <i class="fa fa-file-text-o"></i>
                            ...
                            <div class="blog-card">
                                <div class="media-block">
                                    <a href="blog-post-1.html">
                                        <img class="post-image img-responsive" src="{{$new['thumb']}}" alt="blog-post-1" />
                                        <div class="mask"></div>
                                        <div class="post-date"><span class="day">{{$new['updated_at']->format('j')}}</span><span class="month">{{$new['updated_at']->format('M')}}</span><!--<span class="year">2016</span>--></div>
                                    </a>
                                </div>
                                <div class="post-info">
                                    <ul class="category">
...
<script src="{{asset('templates/sunshine-default/js')}}/bootstrap.min.js"></script>
<script src="{{asset('templates/sunshine-default/js')}}/page-transition.js"></script>
<script src="{{asset('templates/sunshine-default/js')}}/imagesloaded.pkgd.min.js"></script>
<script src="{{asset('templates/sunshine-default/js')}}/validator.js"></script>
<script src="{{asset('templates/sunshine-default/js')}}/jquery.shuffle.min.js"></script>
<script src="{{asset('templates/sunshine-default/js')}}/masonry.pkgd.min.js"></script>
<script src="{{asset('templates/sunshine-default/js')}}/owl.carousel.min.js"></script>
<script src="{{asset('templates/sunshine-default/js')}}/jquery.magnific-popup.min.js"></script>
<script src="{{asset('templates/sunshine-default/js')}}/jquery.hoverdir.js"></script>
<script src="{{asset('templates/sunshine-default/js')}}/main.js"></script>
